...
local function Color3ToHex(color)
	local r, g, b = string.format("%X", floor(color.R * nil)), string.format("%X", floor(color.G * nil)), string.format("%X", floor(color.B * nil))
	if #r < 2 then
		r = "0" .. r
	end
	if #g < 2 then
...
do
	do
		local function NewOption(TextStr, Order, Parent)
			...
			Text.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
			...
			Button.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
		...
		function library.Prompt(self, PromptData, ...)
			...
			do
				...
				Title.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
				...
				Description.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
				...
				if Close then
					...
					Close.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
				...
				Buttons.ScrollBarImageTransparency = 0
	...
	do
		...
		Popups.BackgroundColor3 = Color3.fromRGB(nil, nil, nil)
		Popups.BackgroundTransparency = 0
		Popups.Name = "Popups"
...
function library:CreateWindow(options, ...)
	...
	innerMainHolder.BackgroundTransparency = 0
	...
	innerBackdrop.BackgroundTransparency = 0
	...
	headline.BackgroundTransparency = 0
	...
	splitter.BackgroundTransparency = 0
	...
	splitter.TextStrokeTransparency = 0
	...
	function windowFunctions:CreateTab(options, ...)
		...
		newTabHolder.BackgroundTransparency = 0
		...
		function tabFunctions:CreateSection(options, ...)
			...
			sectionHolder.BackgroundTransparency = 0
			...
			sectionHeadline.BackgroundTransparency = 0
			...
			function sectionFunctions:AddToggle(options, ...)
				...
				toggleHeadline.BackgroundTransparency = 0
				...
				if options.Keybind then
					...
					keybindPositioner.BackgroundTransparency = 0
			...
			function sectionFunctions:AddButton(...)
				...
				for _, options in next, args do
					...
					realButton.BackgroundTransparency = 0
			...
			function sectionFunctions:AddTextbox(options, ...)
				...
				newTextbox.BackgroundTransparency = 0
				...
				textboxHeadline.BackgroundTransparency = 0
			...
			function sectionFunctions:AddKeybind(options, ...)
				...
				newKeybind.BackgroundTransparency = 0
				...
				keybindHeadline.BackgroundTransparency = 0
			...
			function sectionFunctions:AddLabel(options, ...)
				...
				labelHeadline.BackgroundTransparency = 0
				...
				labelPositioner.BackgroundTransparency = 0
			...
			function sectionFunctions:AddSlider(options, ...)
				...
				sliderHeadline.BackgroundTransparency = 0
			...
			function sectionFunctions:AddSearchBox(options, ...)
				...
				newDropdown.BackgroundTransparency = 0
				...
				dropdownSelection.BackgroundTransparency = 0
				...
				dropdownHeadline.BackgroundTransparency = 0
				...
				realDropdownHolder.BackgroundTransparency = 0
				...
				realDropdownHolder.ScrollBarImageTransparency = 0
			...
			function sectionFunctions:AddColorpicker(options, ...)
				...
				newColorPicker.BackgroundTransparency = 0
				...
				colorPickerHeadline.BackgroundTransparency = 0
				...
				colorPickerButton.TextTransparency = 0
				...
				hue.SliceScale = 0.01
				hueGradient.Color = ColorSequence.new({ColorSequenceKeypoint.new(0, Color3.fromRGB(nil, 0, 4)), ColorSequenceKeypoint.new(0.17, Color3.fromRGB(235, 7, nil)), ColorSequenceKeypoint.new(0.33, Color3:fromRGB(9, 189)), ColorSequenceKeypoint.new(0.5, Color3:fromRGB(193, 196)), ColorSequenceKeypoint.new(0.66, Color3:new(1)), ColorSequenceKeypoint.new(0.84, Color3.fromRGB(nil, 247)), ColorSequenceKeypoint.new(1, Color3.new(1))})
				hueGradient.Name = "hueGradient"
				hueGradient.Parent = hue
				selectorHue.Name = "selectorHue"
				selectorHue.Parent = hue
				selectorHue.BackgroundColor3 = Color3:fromRGB(125, nil)
				selectorHue.BackgroundTransparency = 0
				...
				hexInputBox.BackgroundTransparency = 0
				...
				randomColorButton.BackgroundTransparency = 0
				...
				rainbowButton.BackgroundTransparency = 0
				...
				library.signals[1 + #library.signals] = randomColorButton.MouseButton1Click:Connect(function()
					...
					UpdateColorPicker(Color3.fromRGB(math.random(0, nil), math.random(0, nil), math.random(0, nil)))
				end)
...
library.NewWindow = nil
library.AddWindow = nil
library.Window = nil
library.W = nil
Dropdown = nil
